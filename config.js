var Config = {
  //默认分享文字
  share_text: {
    title: "风靡全国的拼团商城，优质水果新鲜直供，快来一起“维当鲜”吧",
    path: "pages/index"
  },

  //接口 基础 url
  baseApiUrl: "https://weixian.w3w.top/index.php",
  ...
  userInfo: {
    nickName: "游客",
    avatarUrl: "http://139.199.168.122:8989/Public/Api/images/logo_2.jpg"
  },
  ...
  group_pic: {
    defaultAvatar:
      "http://139.199.168.122:8989/Public/Api/images/avatar_4_64.png"
  }
};
